          ...
          <div className="w-full">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:flex-shrink-0">
                <button
                  type="submit"
                  className="flex-1 sm:flex-initial px-6 py-1.5 text-sm text-gray-800 border border-gray-300 hover:border-gray-800 hover:text-gray-900 transition-all duration-200"
                >
                  Get updates
                </button>
                <a 
                  ...
                  className="flex-1 sm:flex-initial px-3 py-1.5 text-sm text-gray-800 border border-gray-300 hover:border-gray-800 hover:text-gray-900 transition-all duration-200 flex items-center justify-center"
                >
