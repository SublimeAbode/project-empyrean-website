          ...
          <div className="w-full">
            ...
            >
              <input
                ...
                className="flex-1 px-3 py-1.5 text-sm border-b border-border focus:outline-none focus:border-border-hover bg-transparent transition-colors placeholder:text-gray-400"
                required
              />
              <div className="flex flex-col sm:flex-row gap-2 sm:flex-shrink-0">
                <button
                  type="submit"
                  className="flex-1 sm:flex-initial px-6 py-1.5 text-sm text-text border border-border hover:border-border-hover hover:text-text-dark transition-all duration-200"
                >
                  Get updates
                </button>
                <a 
                  ...
                  className="flex-1 sm:flex-initial px-3 py-1.5 text-sm text-text border border-border hover:border-border-hover hover:text-text-dark transition-all duration-200 flex items-center justify-center"
                >
