            ...
            <div className="w-full animate-fade-in delay-700">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:flex-shrink-0">
                  <button
                    type="submit"
                    className="flex-1 sm:flex-initial px-6 py-1.5 text-sm text-text dark:text-text-dark border border-border dark:border-border-dark hover:border-border-hover dark:hover:border-border-dark-hover transition-all duration-200 rounded-md"
                  >
                    Get updates
                  </button>
                  <a 
                    ...
                    className="flex-1 sm:flex-initial px-3 py-1.5 text-sm text-text dark:text-text-dark border border-border dark:border-border-dark transition-all duration-200 flex items-center justify-center rounded-md"
                  >
